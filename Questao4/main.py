...
def exibir_menu():
    ...
    print("16 - Somar Dois Bancos")  # Nova opção
    print("17 - Sair")
...
while True:
    ...
    elif opcao == "16":  # Somar dois bancos
        banco2_numero = int(input("Número do segundo banco: "))
        # Supondo que você cria outro banco assim
        banco2 = Banco(banco2_numero)
        try:
            soma_bancos = banco + banco2
            print(f"Soma dos bancos: {soma_bancos}")
        except TypeError as e:
            print(e)
